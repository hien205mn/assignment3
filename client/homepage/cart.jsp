        ...
        <script>
            document.addEventListener('DOMContentLoaded', function () {
                ...
                window.proceedToCheckout = function () {
                    ...
                    const checkoutUrl = '/phoneshop/checkout?cartIds=' + cartIds.join(',');
                        ...
                        <tbody>
                            <c:forEach var="c" items="${requestScope.cartItems}">
                                <tr>
                                    <td class="align-middle">
                                        <c:choose>
                                            <c:when test="${c.product.storage == 0}">
                                                <span class="text-danger">Not existed</span>
                                            </c:when>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <p class="mb-0 mt-4" style="cursor: pointer;" 
                                                   onclick="window.location.href = '/phoneshop/product?id=${c.product.id}'">
                                                    ${c.product.name}
                                                </p>
                                            </c:otherwise>
                                        </c:choose>
                                        ...
                                        <div class="input-group quantity mt-4" style="width: 100px;">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <button class="btn btn-sm btn-minus rounded-circle bg-light border" 
                                                                onclick="window.location.href = '/phoneshop/editquantitycart?cartItemId=${c.cartItemId}&quantity=${c.quantity - 1}&productId=${c.product.id}'">
                                                            <i class="fa fa-minus"></i>
                                                        </button>
                                                    </c:otherwise>
                                                </c:choose>
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <input type="text" class="form-control form-control-sm text-center border-0 w-25"
                                                           value="${c.quantity}"
                                                           onchange="window.location.href = '/phoneshop/editquantitycart?cartItemId=${c.cartItemId}&quantity=' + this.value + '&productId=${c.product.id}'">
                                                </c:otherwise>
                                            </c:choose>
                                            <div class="input-group-btn">
                                                <c:choose>
                                    ...
                                    <td>
                                        <button onclick="window.location.href = '/phoneshop/deletecart?id=${c.product.id}'" 
