...
<html lang="en">
    ...
    <head>
        ...
        <title>Phone - ${product.name}</title>
    ...
    <body>
        ...
        <div class="container-fluid py-5 mt-5">
            <div class="container py-5">
                ...
                <h1 class="fw-bold mb-0" style="font-size: 35px; color: #81C408">Related products</h1>
                <div class="vesitable">
                    <div class="owl-carousel vegetable-carousel justify-content-center">
                        <c:forEach var="p" items="${requestScope.products}">
                            <div class="border border-primary rounded position-relative vesitable-item" style="height: 400px">
                                ...
                                <div class="text-white bg-primary px-3 py-1 rounded position-absolute" style="top: 10px; right: 10px;">Phone</div>
