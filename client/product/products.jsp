                            ...
                            <div class="row g-4">
                                <div>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="/phoneshop/homepage">Home</a></li>
                            ...
                            <div class="row g-4">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="mb-3">
                                                <h4>Chip</h4>
                                                <div class="mb-2">
                                                    <input type="radio" class="me-2" id="Categories-1" name="chipCate" value="Snapdragon" 
                                                           onchange="this.form.submit()" onclick="toggleRadio(this)"
                                                           ${chipCate == 'Snapdragon' ? 'checked' : ''}>
                                                    <label for="Categories-1"> Snapdragon</label>
                                                </div>
                                                <div class="mb-2">
                                                    <input type="radio" class="me-2" id="Categories-2" name="chipCate" value="MediaTek" 
                                                           onchange="this.form.submit()" onclick="toggleRadio(this)"
                                                           ${chipCate == 'MediaTek' ? 'checked' : ''}>
                                                    <label for="Categories-2"> MediaTek</label>
                                                </div>
                                                <div class="mb-2">
                                                    <input type="radio" class="me-2" id="Categories-3" name="chipCate" value="Apple Bionic" 
                                                           onchange="this.form.submit()" onclick="toggleRadio(this)"
                                                           ${chipCate == 'Apple Bionic' ? 'checked' : ''}>
                                                    <label for="Categories-3"> Apple Bionic</label>
                                                </div>
                                                <div class="mb-2">
                                                    <input type="radio" class="me-2" id="Categories-3" name="chipCate" value="Google Tensor" 
                                                           onchange="this.form.submit()" onclick="toggleRadio(this)"
                                                           ${chipCate == 'Google Tensor' ? 'checked' : ''}>
                                                    <label for="Categories-3"> Google Tensor</label>
                                                </div>
                                                <div class="mb-2">
                                                    <input type="radio" class="me-2" id="Categories-3" name="chipCate" value="" 
                                                           onchange="this.form.submit()" onclick="toggleRadio(this)"
                                                           ${(chipCate == null || chipCate == '') ? 'checked' : ''}>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="position-relative">
                                                <img src="${pageContext.request.contextPath}/resources/client/img/sale1.jpg" class="img-fluid w-100 rounded" alt="">
                                ...
                                <div class="col-lg-9">
                                    <div class="row g-4 justify-content-center">
                                        <c:if test="${result == 0}">
                                            <p>Can not find suitable product.</p>
                                        </c:if>
                                        <c:if test="${result > 0}">
                                            <p>Find ${result} products.</p>
                                        </c:if>
                                                    ...
                                                    <ul class="pagination justify-content-center">
                                                        ...
                                                        <li class="page-item ${currentPage == 1 ? 'disabled' : ''}">
                                                            <a class="page-link" href="?page=${currentPage - 1}
                                                               ...
                                                               ${not empty chipCate ? '&chipCate=' : ''}${chipCate}
